...
(mes
 ...
 (seg (? (= S 1) (= 339 #t))
   (proc 0)
   (str "This crumbling building seems perfect for criminals trying to" 'br)
 ...
 (seg (? (= S 1) (= 338 #f))
   ...
   (wait)
   (text-reset 14)
   (str "Despite nearly collapsing, the entrance has just enough space" 'br)
 ...
 (seg (? (= S 3) (= 342 #f))
   (proc 0)
   (str "It should be packed with cars, but through the gaping windows" 'br)
 ...
 (seg (? (= S 4) (= 60 #t)) ; Line after Lei-Fa interrogation scene
   ...
   (str "「Vagrant」" 'br)
   (text-delay 2)
   (str "Thanks for earlier, lady. First woman I've had in five years!" 'br)
 ...
 (seg (? (= S 4) (= 344 #f))
   ...
   (str "「Kiyomi」" 'br)
   (text-delay 2)
   (str "Help ease my suffering and tell me something. There's a woman" 'br)
   ...
   (str "「Kiyomi」" 'br)
   (text-delay 2)
   (str "If you've been hanging around here, you should know something" 'br)
 ...
 (seg (? (= S 4) (= 345 #f))
   ...
   (str "「Vagrant」" 'br)
   (text-delay 2)
   (str "Lady, how much you getting for finding this woman? Share some" 'br)
   ...
   (str "「Kiyomi」" 'br)
   (text-delay 2)
   (str "However far we've fallen, we're still the same people, right?" 'br)
   ...
   (str "「Vagrant」" 'br)
   (text-delay 2)
   (str "Alright. There's been an unfamiliar woman going in and out of" 'br)
 ...
 (seg (? (= S 5))
   ...
   (if (</>
         ...
         (branch-index
          (</>
           (/
            ...
            (text-reset 14))
           (/
            (str "If I interrogate Mitsuko, I should learn about the mastermind" 'br)
         ...
         (branch-index
          (</>
           (/
            ...
            (wait)
            (text-reset 14)
            (str "And Mitsuko and Nana were lovers. The story about them hiding" 'br)
        ...
        (//
         (? (= 57 #f) (= 58 #f) (= 59 #t) (= 60 #f))
         (nop@)
         (str "I've arrested Lei-Fa. Interrogating her might provide the key" 'br)
