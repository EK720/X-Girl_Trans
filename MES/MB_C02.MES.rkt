...
(mes
 ...
 (seg (? (= S 3) (= 343 #f))
   ...
   (wait)
   (text-reset 14)
   (str "Besides signs of destruction, you can see evidence of" 'br)
   (str "looting. That must have happened years ago.")
   (wait)
   (text-reset 14)
   (nop@)
   (set-reg 343 #t)
 ...
 (seg (? (= S 3) (= 343 #t))
   (proc 0)
   (str "Besides signs of destruction, you can see terrible looting" 'br)
 ...
 (seg (? (= S 4) (= 344 #f))
   (proc 0)
   (str "He's frozen, watching my every move. Is he scared of me, or" 'br)
   (str "is he sizing me up to see if I'm worth robbing?")
   (wait)
   (text-reset 14)
   ...
   (str "「Vagrant」" 'br)
   (text-delay 2)
   (str "Who's your buddy? You get a warm room and good food while I" 'br)
   (str "gotta walk all night to keep from freezing to death.")
   (wait)
   (text-reset 14)
   (text-delay 0)
   (str "「Kiyomi」" 'br)
 ...
 (seg (? (= S 4) (= 345 #f))
   ...
   (str "「Kiyomi」" 'br)
   (text-delay 2)
   (str "Fine, fine. I'm with Intelligence. When you're dying, I'll" 'br)
   (str "make sure Intelligence takes care of you.")
   (wait)
   (text-reset 14)
   (text-delay 0)
   (str "「Vagrant」" 'br)
 ...
 (seg (? (= S 5))
   ...
   (if (</>
        ...
        (//
         (? (= 66 #t))
         (nop@)
         (str "Anna knows Mori? She told me to go to Mori's shop......")
         (wait)
         (text-reset 14))
        (//
         (? (= 65 #t))
         ...
         (branch-index
          (</>
           (/
            (str "That woman I met at the shady shop in Chiba, Mori...... She" 'br)
            (str "seems pretty well-known in Chiba's underworld.")
            (wait)
            (text-reset 14)
            ...
            (str "get Mori to talk?")
            (wait)
            (text-reset 14))
           (/
            (str "Mori seems to know something about Nana and Mitsuko. Even if" 'br)
