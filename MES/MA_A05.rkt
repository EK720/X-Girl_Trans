(mes
 ...
 (seg (? (= 1021 #t))
      ...
      (if (</>
           (//
            ...
            (menu1 6 80 6 96 6 112 6 128 6 144
             (</>
              (/ (text "　ファイル１　"))
              (/ (text "　ファイル２　"))
              (/ (text "　ファイル３　"))
 ...
 (seg (? (= S 2))
      ...
      (menu1 5 72 5 88 5 104 5 120 5 136 5 152
       (</>
        (/ (str " 　　エイプリル　　 "))
        (/ (text "　　　レイファ　　　"))
        (/ (text "　　　　ナナ　　　　"))
           ...
           (//
            ...
            (if (</>
                 ...
                 (//
                  (? (= 72 #t))
                  (nop@)
                  (text "エイプリルを尋問するのは、これで２度目。エリコから得た情報が正しければ、彼女は体内の何処かにチップを隠し持っている。")
                  (wait)
                  (text-reset 14)
                  (text "何かを隠すのに都合がいい場所か、考えればわかる事だ。前の尋問で見つけられなかったのは不覚だが‥‥‥今度は見つけてみせる。")
                  (wait)
                  (text-reset 14)
                  (exec-mem 3072 0)
           ...
           (//
            ...
            (if (</>
                 (//
                  (? (= 76 #t))
                  (nop@)
                  (text "レイファの刺青は、マトリクスの絵か、回路図のように見えた。どんな意味があるのか不明だが、それを調べるのは軍の仕事だ。")
                  (wait)
                  (text-reset 14))
                 (//
                  (? (= 72 #t))
           ...
           (//
            ...
            (if (</>
                 ...
                 (//
                  ...
                  (text-reset 14))
                 (//
                  (text "ナナはもう尋問済みだ。これ以上やっても無駄だし、彼女が精神に異常をきたす恐れもある。止めておいた方がいいだろう。")
                  (wait)
                  (text-reset 14)))))
           (//
            (? (= S 3))
           ...
           (//
            ...
            (if (</>
                 ...
                 (//
                  ...
                  (wait)
                  (text-reset 14)
                  (text "彼女が事件の黒幕だとしたら、任務が終わるのは有難い。しかし、少しは楽しませてくれないと苦労した意味がないな‥‥‥")
                  (wait)
                  (text-reset 14)
                  (exec-mem 3072 0)
 ...
 (seg (? (= S 4))
      ...
      (if (</>
           (//
            ...
            (branch-index (</>
                           (/
                            (text "そろそろプリスを尋問していい頃だ。エイプリルとレイファからはもう何も得られないだろうし、プリスは全てを知っているようだ。")
                            (wait)
                            (text-reset 14)
           ...
           (//
            ...
            (branch-index (</>
                           (/
                            ...
                            (wait)
                            (text-reset 14)
                            (text "名誉を重んじるザイバツの中に、エリコのような混血児がいるのは体裁が悪かったろう。エリコは父やその血族に復讐する為に、事件を起こしたのかもしれない。"))
                           (/
           ...
           (//
            (branch-index (</>
                           (/
                            ...
                            (wait)
                            (text-reset 14)
                            (text "エリコはサカタ・ジクムント　ユニバーサル　ネオテクの社長令嬢だという。サカタ・ネオテクは有数のザイバツだ。軍とも深い繋がりがあると言う。"))
                           (/
