(mes
 ...
 (seg (? (= S 1) (= 218 #f))
   ...
   (text "passed it on to the mastermind who hired them.")
   (wait)
   (text-reset 14)
   (text-delay 0)
   (text "「Kiyomi」" 'br)
 ...
 (seg (? (= S 3) (= 222 #f))
   ...
   (wait)
   (text-reset 14)
   (text "The view is blocked by overgrown tree branches, and the sound from outside is muffled as well.")
   (wait)
   (text-reset 14)
 ...
 (seg (? (= S 4) (= 224 #f))
   (proc 0)
   (text "Anna's room is full of furniture from her homeland, making it one of the most unique rooms in the division.")
   (wait)
   (text-reset 14)
