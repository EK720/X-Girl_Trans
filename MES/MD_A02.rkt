(mes
 ...
 (seg (? (= Y 1) (= S 1) (<= H 5))
      ...
      (branch-index (</>
                     ...
                     (/
                      (proc 13)
                      (text "あんたみたいな淫乱は見た事がないね、わたしが言うんだから間違いないよ。")
                      (proc 18))))
      (proc 11))
 (seg (? (= Y 1) (= S 1) (<= H 10))
      (proc 10)
 ...
 (seg (? (= Y 1) (= S 1) (<= H 16))
      ...
      (branch-index (</>
                     ...
                     (/
                      (proc 13)
                      (text "上のお口も下のと同じくらい正直になるまでは、やめないからね。")
                      (proc 18))))
      (proc 11))
 (seg (? (= Y 1) (= S 2))
      (sound 'se 1)
 ...
 (seg (? (= Y 2) (= S 1) (<= H 10))
      ...
      (branch-index (</>
                     ...
                     (/
                      (proc 14)
                      (text "許して、何でも言う事を聞きます。あなたの奴隷になりますから！")
                      (proc 18))))
      (proc 11))
 (seg (? (= Y 2) (= S 1) (<= H 16))
      (proc 10)
