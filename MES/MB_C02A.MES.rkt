...
(mes
 ...
 (seg*
  ...
  (str "into Lei-Fa's body. If she's nearby, I should be able to tell" 'br)
 ...
 (seg (? (= S 1) (= 347 #f))
   ...
   (str "equipment. Either way, they clearly had value in the")
   (str "looters' eyes.")
   (wait)
   (text-reset 14)
   (nop@)
 ...
 (seg (? (= S 2) (= 348 #f))
   ...
   (str "appears to be a bathroom. I can see the remains of a tattered" 'br)
   (str "curtain.")
   (wait)
   (text-reset 14)
 ...
 (seg (? (= S 4) (= 352 #f))
   ...
   (wait)
   (text-reset 14)
   (str "But then again, we underground dwellers always live with that" 'br)
 ...
 (seg (? (= S 5) (= 356 #t))
   ...
   (wait)
   (text-reset 14)
   (str "But she's ex-Special Forces. Do I have any chance of winning?" 'br)
 ...
 (seg (? (= S 6) (= 356 #f) (= 355 #t))
   ...
   (str "「Kiyomi」" 'br)
   (text-delay 2)
   (str "Attacking me isn't smart. I'm with Intelligence - kill me and" 'br)
 ...
 (seg (? (= S 6) (= 349 #t) (= 353 #t) (= 930 #f))
   (proc 0)
   (str "Looking around, I can't find anything that confirms Lei-Fa is" 'br)
   (str "here. Maybe it's time to use those goggles.")
   (wait)
   (text-reset 14)
   (nop@)
