...
(mes
        ...
        (//
         ...
         (if (</>
              (//
               ...
               (nop@)
               (set-reg 906 #t)
               (mes-jump "mes¥MB_C01.MES")) ; Go to Outside Ruined Building
              (// (? (= S 255))))))
 ...
 (seg (? (= S 1) (= 255 #f))
   ...
   (wait)
   (text-reset 14)
   (str "I don't know what all these colorful wires were used for," 'br)
   (str "but there's no doubt they're dead.")
   (wait)
   (text-reset 14)
   (nop@)
   (set-reg 255 #t)
 ...
 (seg (? (= S 2) (= 257 #f))
   ...
   (wait)
   (text-reset 14)
   (str "The unexpectedly old-fashioned design is surprising." 'br)
   (str "A Western-style bathtub with wood flooring wouldn't have been")
 ...
 (seg (? (= S 2) (= 258 #f))
   ...
   (wait)
   (text-reset 14)
   (str "Just touching it would probably make me sick......" 'br)
   (str "Surely no one would be hiding in there.")
   (wait)
   (text-reset 14)
   (nop@)
   (set-reg 258 #t)
 ...
 (seg (? (= S 3) (= 260 #f))
   (proc 0)
   (str "Debris that was probably once part of the walls, roof," 'br)
   (str "or furniture is scattered around.")
   (wait)
   (text-reset 14)
