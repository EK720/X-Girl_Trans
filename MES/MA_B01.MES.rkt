(mes
 ...
 (seg (? (= S 1) (= 210 #f))
   ...
   (text "「Katou」" 'br)
   (text-delay 2)
   (text "I respect the badge, not the wearer. This is business. I have no intention of letting personal feelings get in the way.")
   (wait)
   (text-reset 14)
   (text-delay 0)
   (text "「Katou」" 'br)
   ...
   (text "「Kiyomi」" 'br)
   (text-delay 2)
   (text "Well, I'm honored... But still, I don't think it was smart to choose me for this mission.")
   (wait)
   (text-reset 14)
   (text-delay 0)
   (text "「Katou」" 'br)
